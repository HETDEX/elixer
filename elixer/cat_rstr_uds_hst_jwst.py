...
"""
cloned from cat_rstr_cosmos_hst_jwst.py

This is UDS imaging from HST (acs, wfc3) and JWST (nrc)
...
UDS_HST_BASEPATH = "/work/03564/stevenf/lonestar/JWST_images/UDS"
...
class UDS_HST(cat_base.Catalog):
    ...
    Image_Coord_Range = {'RA_min': 34.194009, 'RA_max': 34.543846, 'Dec_min': -5.334266, 'Dec_max': -5.067609}
    ...
    CatalogImages = [
        {'path': UDS_HST_BASEPATH,
         'name': 'primeruds_acs_f435w_sci.fits',
         'filter': 'f435w',
         'instrument': 'ACS WFC',
        ...
        {'path': UDS_HST_BASEPATH,
         'name': 'primeruds_acs_f606w_sci.fits',
         'filter': 'f606w',
         'instrument': 'ACS WFC',
