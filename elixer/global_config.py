...
LAE_G_MAG_ZERO = 24.3#24.0 #somewhat empirical:   ( -0.20 to + 0.27) for z 1.9 to 3.5
LAE_R_MAG_ZERO = 24.0#23.8 #somewhat empirical: . .. also using -0.2 or -0.3 mag from g-band per Leung+2017
