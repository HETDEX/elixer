...
LAE_G_MAG_ZERO = 24.5 #somewhat empirical: 24.3 to 24.77  ( -0.20 to + 0.27) for z 1.9 to 3.5
LAE_R_MAG_ZERO = 24.3 #somewhat empirical: 24.1 to 24.57 ... also using -0.3 mag from g-band per Leung+2017
