...
FULL_WEIGHT_MULT = 0.5  #in fiber radius units ... ie. 0.5 * Fiber_Radius
ZERO_WEIGHT_MULT = 2.0
FULL_WEIGHT_DISTANCE = FULL_WEIGHT_MULT * Fiber_Radius
ZERO_WEIGHT_DISTANCE = ZERO_WEIGHT_MULT * Fiber_Radius
